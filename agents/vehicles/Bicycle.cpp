...
Bicycle::Bicycle(GSSGeometry* geom , QObject* parent) : Vehicle( geom , parent ){
    this->getStyle()->border_weight = 6;
    this->getStyle()->icon_url = "http://image.flaticon.com/icons/png/128/145/145703.png";
    ...
    foreach(Skill* s , this->getSkills(AgentStoreSkill::staticMetaObject.className())){
        dynamic_cast<AgentStoreSkill*>(s)->setMaxCapacity( 1 );
    }
}
