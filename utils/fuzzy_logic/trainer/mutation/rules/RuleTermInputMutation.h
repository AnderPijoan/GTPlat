...
public:
    RuleTermInputMutation(FuzzyLogicTrainer *parent) : RuleMutationOperator(parent){};
    ...
    virtual QList< FuzzyLogic::Rule > mutation(QList<FuzzyLogic::Rule> rs){
        ...
        QStringList input_names = dynamic_cast<FuzzyLogicTrainer*>( this->parent() )->getInputNames().keys();
