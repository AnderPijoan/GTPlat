...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Road_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Road_t qt_meta_stringdata_Road = {
    {
QT_MOC_LITERAL(0, 0, 4) // "Road"
...
const QMetaObject Road::staticMetaObject = {
    { &TransportLine::staticMetaObject, qt_meta_stringdata_Road.data,
      qt_meta_data_Road,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Road::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Road.stringdata0))
        return static_cast<void*>(const_cast< Road*>(this));
