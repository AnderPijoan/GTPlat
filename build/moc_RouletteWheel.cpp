...
const QMetaObject RouletteWheel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RouletteWheel.data,
      qt_meta_data_RouletteWheel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RouletteWheel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RouletteWheel.stringdata0))
        return static_cast<void*>(const_cast< RouletteWheel*>(this));
