...
const QMetaObject NeuralNetwork::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NeuralNetwork.data,
      qt_meta_data_NeuralNetwork,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NeuralNetwork::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NeuralNetwork.stringdata0))
        return static_cast<void*>(const_cast< NeuralNetwork*>(this));
