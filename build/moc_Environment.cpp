...
QT_MOC_LITERAL(1, 12, 21), // "pushToInterfaceSignal"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 4), // "data"
QT_MOC_LITERAL(4, 40, 9), // "operation"
QT_MOC_LITERAL(5, 50, 14), // "runEnvironment"
QT_MOC_LITERAL(6, 65, 15), // "stopEnvironment"
QT_MOC_LITERAL(7, 81, 6) // "behave"

    },
    "Environment\0pushToInterfaceSignal\0\0"
    "data\0operation\0runEnvironment\0"
    "stopEnvironment\0behave"
};
...
void Environment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pushToInterfaceSignal((*reinterpret_cast< QJsonObject(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->runEnvironment(); break;
        case 2: _t->stopEnvironment(); break;
        case 3: _t->behave(); break;
        default: ;
        }
        ...
        {
            typedef void (Environment::*_t)(QJsonObject , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Environment::pushToInterfaceSignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Environment::staticMetaObject = {
    { &Agent::staticMetaObject, qt_meta_stringdata_Environment.data,
      qt_meta_data_Environment,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void Environment::pushToInterfaceSignal(QJsonObject _t1, QString _t2)
{
