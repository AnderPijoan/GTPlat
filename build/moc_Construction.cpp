/****************************************************************************
** Meta object code from reading C++ file 'Construction.h'
**
...
#error "The header file 'Construction.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Construction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Construction_t qt_meta_stringdata_Construction = {
    {
QT_MOC_LITERAL(0, 0, 12) // "Construction"
...
const QMetaObject Construction::staticMetaObject = {
    { &Place::staticMetaObject, qt_meta_stringdata_Construction.data,
      qt_meta_data_Construction,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Construction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Construction.stringdata0))
