...
struct qt_meta_stringdata_Skill_t {
    QByteArrayData data[1];
    char stringdata0[6];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Skill_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Skill_t qt_meta_stringdata_Skill = {
    {
QT_MOC_LITERAL(0, 0, 5) // "Skill"
...
const QMetaObject Skill::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Skill.data,
      qt_meta_data_Skill,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Skill::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Skill.stringdata0))
